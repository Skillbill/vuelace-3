import{d as b}from"./VLTextArea-D-cT8AaM.js";import"./vue.esm-bundler-BYZbTIRI.js";import"./api.esm-C3jrVNCq.js";const M={title:"Components/Date picker",component:b,tags:["autodocs"],argTypes:{selectionMode:{control:"select",options:["single","range","multiple",void 0]}},args:{}},e={args:{label:"Date of birth (VLDatePicker)",rules:[{validateFn:n=>!!n,message:"The value is required"},{validateFn:n=>n.getTime()<new Date().getTime(),message:"Oh...it seems you are not born yet!"}]}},a={args:{label:"Date",name:"DateInput",placeholder:"Select a date...",selectionMode:"multiple"}},t={args:{label:"Date",name:"DateInput",placeholder:"Select a date...",selectionMode:"range"}},r={args:{label:"Date",name:"DateInput",placeholder:"Select a date and time...",withTime:!0}};var s,o,l;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
